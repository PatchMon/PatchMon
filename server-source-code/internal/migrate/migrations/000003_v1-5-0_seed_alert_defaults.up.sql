...
VALUES
    ...
    (gen_random_uuid()::TEXT, 'assigned', 'Assigned', 'Alert was assigned/delegated to a user', false, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (gen_random_uuid()::TEXT, 'unassigned', 'Unassigned', 'Alert assignment was removed', false, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    (gen_random_uuid()::TEXT, 'silenced', 'Silenced', 'Alert was silenced', false, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (gen_random_uuid()::TEXT, 'unsilenced', 'Unsilenced', 'Alert was unsilenced', false, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
