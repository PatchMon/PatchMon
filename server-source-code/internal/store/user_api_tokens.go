...
// CreateRowToUserApiTokenListItem converts the distinct row type returned by
// the CreateUserApiToken query (same columns as ListUserApiTokensRow, but a
// separate sqlc-generated struct).
