...
// All contexts share the default Redis instance; isolation is handled by
// key-prefixing (TenantKey) in the stores rather than per-context DB indices.
type RedisCache struct {
	defaultRDB *redis.Client
	log        *slog.Logger
}

// NewRedisCache creates a new Redis cache. All contexts share the default client.
...
// GetOrCreate returns the shared Redis client. Context isolation is handled by
...
// Evict is a no-op since all contexts share the default client.
